    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(r21!=null){
                    Toast.makeText(Main5Activity.this,"Your Ans "+r21.getText()+" is Sucessfully Saved",Toast.LENGTH_SHORT).show();
                    Intent i=new Intent(Main5Activity.this,Main6Activity.class);
                    i.putExtra("Result",String.valueOf(a));
                    startActivity(i);
                    finish();}
                else
                    Toast.makeText(Main5Activity.this, "Please select One of the Option", Toast.LENGTH_SHORT).show();
            }
